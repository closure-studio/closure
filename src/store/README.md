...
The same Store persists validated Game Resource Catalog downloads under a fixed second key. This keeps large resource tables out of frequent User Session and ArkHost Snapshot writes while preserving one Store and one persistence boundary across native and web.
