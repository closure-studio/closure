...
export function GameLogsView({ entries }: { entries: readonly ArkHostGameLogEntry[] }) {
  const { t } = useTranslation('dashboard');

  return (
    <YStack testID="game-logs-view" width="100%" maxW={860} self="center" gap="$3.5" pb="$4">
      <TerminalSectionHeading code="LOG" title={t('logs.title')} subtitle={t('logs.subtitle')} />
